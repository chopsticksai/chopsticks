...
import type { Approval, HeartbeatRun, Issue, JoinRequest } from "@runeachai/shared";
import {
...
function FailedRunInboxRow({
  ...
  const fallbackTitle = linkedAgentName ? `${t("Failed run")} - ${linkedAgentName}` : t("Failed run");
...
export function Inbox() {
  ...
  const workItemsToRender = useMemo(
    ...
    [approvalsToRender, failedRunsForTab, issuesToRender, showApprovalsCategory, showTouchedCategory, tab],
  );
