...
import type { CostByProviderModel, CostWindowSpendRow, QuotaWindow } from "@runeachai/shared";
            ...
            <CardDescription className="text-xs mt-0.5">
              ...
              {(totalApiRuns > 0 || totalSubRuns > 0) && (
                <span className="ml-1.5">
                  ·{" "}
                  {totalApiRuns > 0 && `~${totalApiRuns} ${t("api")}`}
                  {totalApiRuns > 0 && totalSubRuns > 0 && " / "}
                  {totalSubRuns > 0 && `~${totalSubRuns} ${t("sub")}`}
                  {` ${t("runs")}`}
                </span>
              )}
            </CardDescription>
