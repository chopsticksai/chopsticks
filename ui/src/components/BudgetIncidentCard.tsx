...
import type { BudgetIncident } from "@runeachai/shared";
...
export function BudgetIncidentCard({
  ...
  const { t } = useI18n();
  const scopeTypeLabel = incident.scopeType === "company" ? t("Company") : incident.scopeType === "agent" ? t("Agent") : t("Project");
        ...
        <div className="flex items-start justify-between gap-3">
          <div>
            <div className="text-[11px] uppercase tracking-[0.22em] text-red-200/80">
              {t("{scopeType} hard stop", { scopeType: scopeTypeLabel })}
            </div>
