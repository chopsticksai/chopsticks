...
const DEFAULT_AGENT_NAME = "CEO";
const DEFAULT_TASK_TITLE = "Create your CEO HEARTBEAT.md";
...
export function OnboardingWizard() {
  ...
  // Step 2
  const [agentName, setAgentName] = useState(() => t(DEFAULT_AGENT_NAME));
  ...
  // Step 3
  const [taskTitle, setTaskTitle] = useState(() => t(DEFAULT_TASK_TITLE));
  ...
  function reset() {
    ...
    setCompanyName("");
    setCompanyGoal("");
    setAgentName(t(DEFAULT_AGENT_NAME));
    ...
    setTaskTitle(t(DEFAULT_TASK_TITLE));
    setTaskDescription(t(DEFAULT_TASK_DESCRIPTION));
                ...
                <div className="space-y-5">
                      ...
                      <div className="space-y-3">
                        <div>
                          <div className="flex items-center gap-1.5 mb-1">
                            ...
                            <HintIcon text="Chopsticks works best if you create a new folder for your agents to keep their memories and stay organized. Create a new folder and put the path here." />
                          </div>
                      ...
                      {shouldSuggestUnsetAnthropicApiKey && (
                        <div className="rounded-md border border-amber-300/60 bg-amber-50/40 px-2.5 py-2 space-y-2">
                          <p className="text-[11px] text-amber-900/90 leading-relaxed">
                            {t("Claude failed while")} <span className="font-mono">ANTHROPIC_API_KEY</span>{" "}
                          ...
                          >
                            {unsetAnthropicLoading ? t("Retrying...") : t("Unset ANTHROPIC_API_KEY")}
                          </Button>
                        </div>
                      )}
                  ...
                  {adapterType === "process" && (
                    <div className="space-y-3">
                      ...
                      <div>
                        <label className="text-xs text-muted-foreground mb-1 block">
                          {t("Args (comma-separated)")}
                        </label>
                        <input
                          className="w-full rounded-md border border-border bg-transparent px-3 py-2 text-sm font-mono outline-none focus:ring-1 focus:ring-ring placeholder:text-muted-foreground/50"
                          placeholder={t("e.g. script.js, --flag")}
                          value={args}
                  ...
                  <div className="border border-border divide-y divide-border">
                    ...
                    <div className="flex items-center gap-3 px-3 py-2.5">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-muted-foreground">
                          {translateText(getUIAdapter(adapterType).label)}
                        </p>
                      </div>
                      <Check className="h-4 w-4 text-green-500 shrink-0" />
                    </div>
