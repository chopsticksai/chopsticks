                      ...
                      <div className="space-y-3">
                        <div>
                          <div className="flex items-center gap-1.5 mb-1">
                            ...
                            <HintIcon text="RunEach works best if you create a new folder for your agents to keep their memories and stay organized. Create a new folder and put the path here." />
                          </div>
