  ...
  const surfaces = [
    {
      ...
      icon: Database,
      points: [
        t("tokens + billed dollars"),
        t("provider, biller, model"),
        t("subscription and overage aware"),
      ],
    ...
    },
    {
      ...
      icon: ReceiptText,
      points: [
        t("top-ups, refunds, fees"),
        t("Bedrock provisioned or training charges"),
        t("credit expiries and adjustments"),
      ],
    ...
    },
    {
      ...
      icon: Gauge,
      points: [
        t("provider quota windows"),
        t("biller credit systems"),
        t("errors surfaced directly"),
      ],
