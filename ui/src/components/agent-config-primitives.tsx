...
export const help: Record<string, string> = {
  ...
  cwd: "Default working directory fallback for local adapters. Use an absolute path on the machine running Abacus.",
  ...
  workspaceStrategy: "How Abacus should realize an execution workspace for this agent. Keep project_primary for normal cwd execution, or use git_worktree for issue-scoped isolated checkouts.",
  ...
  payloadTemplateJson: "Optional JSON merged into remote adapter request payloads before Abacus adds its standard wake and workspace fields.",
