...
import { AGENT_ROLE_LABELS } from "@runeachai/shared";
...
export const help: Record<string, string> = {
  ...
  adapterType: "How this agent runs: local CLI (Claude/CodeBuddy/Codex/Gemini/OpenCode/Pi/Cursor), OpenClaw Gateway, spawned process, or generic HTTP webhook.",
  cwd: "Default working directory fallback for local adapters. Use an absolute path on the machine running RunEach.",
  ...
  workspaceStrategy: "How RunEach should realize an execution workspace for this agent. Keep project_primary for normal cwd execution, or use git_worktree for issue-scoped isolated checkouts.",
  ...
  payloadTemplateJson: "Optional JSON merged into remote adapter request payloads before RunEach adds its standard wake and workspace fields.",
