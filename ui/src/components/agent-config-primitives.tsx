...
import { AGENT_ROLE_LABELS } from "@chopsticks/shared";
...
export const help: Record<string, string> = {
  ...
  adapterType: "How this agent runs: local CLI (Claude/CodeBuddy/Codex/Gemini/Qwen/OpenCode/Cursor), OpenClaw Gateway, spawned process, or generic HTTP webhook.",
  cwd: "Default working directory fallback for local adapters. Use an absolute path on the machine running Chopsticks.",
  ...
  dangerouslySkipPermissions: "Run supported local agents without permission prompts. Required for unattended operation.",
  dangerouslyBypassSandbox: "Run Codex without sandbox restrictions. Required for filesystem/network access.",
  search: "Enable Codex web search capability during runs.",
  workspaceStrategy: "How Chopsticks should realize an execution workspace for this agent. Keep project_primary for normal cwd execution, or use git_worktree for issue-scoped isolated checkouts.",
  ...
  localCommand: "Override the path to the CLI command you want the adapter to call (e.g. /usr/local/bin/claude, codebuddy, codex, gemini, qwen, agent, opencode).",
  ...
  payloadTemplateJson: "Optional JSON merged into remote adapter request payloads before Chopsticks adds its standard wake and workspace fields.",
