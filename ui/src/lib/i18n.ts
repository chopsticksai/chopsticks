...
const translations: Record<AppLocale, Record<string, string>> = {
  ...
  "zh-CN": {
    ...
    "Pi requires an explicit model in provider/model format.": "Pi 需要明确指定 `provider/model` 格式的模型。",
    "Failed to load OpenCode models.": "加载 OpenCode 模型失败。",
    "Failed to load Pi models.": "加载 Pi 模型失败。",
    "OpenCode models are still loading. Please wait and try again.": "OpenCode 模型仍在加载中，请稍后重试。",
    "Pi models are still loading. Please wait and try again.": "Pi 模型仍在加载中，请稍后重试。",
    ...
    "No Pi models discovered. Run `pi --list-models` and authenticate providers.": "未发现 Pi 模型。请运行 `pi --list-models` 并完成提供方认证。",
    "Configured OpenCode model is unavailable: {model}": "配置的 OpenCode 模型不可用：{model}",
    "Configured Pi model is unavailable: {model}": "配置的 Pi 模型不可用：{model}",
    ...
    "Tokens {total} (in {input}, out {output})": "Tokens {total}（输入 {input}，输出 {output}）",
    "Tokens {total} (in {input}, out {output}, cached {cached})":
      "Tokens {total}（输入 {input}，输出 {output}，缓存 {cached}）",
    ...
    "Disabled": "已禁用",
    "Disabled unless explicitly granted.": "除非明确授予，否则禁用。",
    "Dismiss notification": "关闭通知",
    "Enable isolated issue checkouts": "启用独立任务检出",
    "Enabled": "已启用",
    "Enabled automatically for CEO agents.": "CEO 代理会自动启用。",
    "Enabled automatically while this agent can create new agents.":
      "当该代理可以创建新代理时会自动启用。",
    "Enabled via explicit company permission grant.": "通过显式的公司权限授予启用。",
    "Environment": "环境",
    "Error:": "错误：",
    ...
    "Link a GitHub repository so agents can clone, read, and push code for this project.":
      "关联一个 GitHub 仓库，让代理可以为该项目克隆、读取并推送代码。",
    "Lets this agent create or hire agents and implicitly assign tasks.":
      "允许该代理创建或招聘新代理，并隐式获得任务分配能力。",
    "Manual debug": "手动调试",
...
完成之后，再为自己招聘一名 Founding Engineer 代理。`,
    ...
    "Unlimited": "无限制",
    "Autosaving...": "自动保存中...",
    "Collapse {key} document": "收起 {key} 文档",
    "Copy document": "复制文档",
    "Could not copy document": "无法复制文档",
    "Could not save": "无法保存",
    "Create document": "创建文档",
    "Delete document": "删除文档",
    "Delete this document? This cannot be undone.": "删除此文档？此操作无法撤销。",
    "Document actions": "文档操作",
    "Document body cannot be empty": "文档内容不能为空",
    "Document changed remotely and the latest version could not be loaded":
      "文档在远端已变更，且无法加载最新版本",
    "Document key": "文档键",
    "Document key and body are required": "文档键和内容均为必填",
    "Document key must start with a letter or number and use only lowercase letters, numbers, -, or _.":
      "文档键必须以字母或数字开头，并且只能使用小写字母、数字、- 或 _。",
    "Documents": "文档",
    "Download document": "下载文档",
    "Expand {key} document": "展开 {key} 文档",
    "Failed to delete document": "删除文档失败",
    "Failed to save document": "保存文档失败",
    "Hide remote": "隐藏远端版本",
    ...
    "Optional title": "可选标题",
    "Out of date": "已过期",
    "Overwrite remote": "覆盖远端",
    "Reload remote": "重新加载远端",
    "Remote revision {count}": "远端修订版 {count}",
    "Review remote": "查看远端",
    "This document changed while you were editing. Your local draft is preserved and autosave is paused.":
      "你编辑期间此文档已发生变更。你的本地草稿已保留，自动保存已暂停。",
    "Use lowercase letters, numbers, -, or _, and start with a letter or number.":
      "请使用小写字母、数字、- 或 _，并以字母或数字开头。",
    "rev {count} • updated {time}": "版本 {count} • 更新于 {time}",
    "Control whether this issue runs in the shared workspace, a new isolated workspace, or an existing one.":
      "控制此任务是在共享工作区、新建隔离工作区，还是现有工作区中运行。",
    "Created {issueRef} with upload warnings": "已创建 {issueRef}，但上传有警告",
    "Execution workspace": "执行工作区",
    "Open {issueRef}": "打开 {issueRef}",
    "Remove attachment": "移除附件",
    "Remove document": "移除文档",
    "Reusing {name} from {source}.": "正在复用来自 {source} 的 {name}。",
    "existing execution workspace": "现有执行工作区",
    "in": "于",
    "{count} staged items could not be added.": "{count} 个暂存项目无法添加。",
    "Clear local folder": "清除本地文件夹",
    "Agent paused by budget": "代理因预算暂停",
    "Project paused by budget": "项目因预算暂停",
    "XHigh": "超高",
    "Billers": "计费方",
    "Finance": "财务",
    "Inference spend, platform fees, credits, and live quota windows.": "推理支出、平台费用、额度返还以及实时配额窗口。",
    "Pending approvals": "待审批",
    "Providers": "提供方",
    "{debits} debits · {credits} credits": "{debits} 支出 · {credits} 返还",
    "Open budgets": "查看预算",
    ...
    "{count} active budget incidents": "{count} 个活跃预算事件",
    "{count} budget overrides awaiting board review": "{count} 个预算覆盖等待董事会审核",
    "Branch": "分支",
    "Cleanup": "清理",
    "Failed to load workspace": "加载工作区失败",
    "Last used": "最近使用",
    "Not scheduled": "未安排",
    "Opened": "打开时间",
    "Provider ref": "提供方引用",
    "Repo URL": "仓库 URL",
    "Repo must use a valid GitHub repo URL.": "仓库必须使用有效的 GitHub 仓库 URL。",
    "Source issue": "来源任务",
    "Set an absolute path on this machine where local agents will read and write files for this project.":
      "在这台机器上设置一个绝对路径，供本地代理读取和写入该项目文件。",
    "Working dir": "工作目录",
    "Enabled Isolated Workspaces": "已启用隔离工作区",
    "Failed to load experimental settings.": "加载实验性设置失败。",
    "Failed to update experimental settings.": "更新实验性设置失败。",
    "Loading experimental settings...": "正在加载实验性设置...",
    "Opt into features that are still being evaluated before they become default behavior.":
      "提前启用仍在评估中的功能，在其成为默认行为之前先行体验。",
    "Show execution workspace controls in project configuration and allow isolated workspace behavior for new and existing issue runs.":
      "在项目配置中显示执行工作区控制，并允许新建和现有任务运行使用隔离工作区行为。",
    "Toggle isolated workspaces experimental setting": "切换隔离工作区实验性设置",
    "Agents with a timer heartbeat enabled across all of your companies.": "你所有公司中已启用定时心跳的代理。",
    "Disable Timer Heartbeat": "禁用定时心跳",
    "Enable Timer Heartbeat": "启用定时心跳",
    "Failed to load scheduler heartbeats.": "加载调度器心跳失败。",
    "Failed to update heartbeat.": "更新心跳失败。",
    "Full agent config": "完整代理配置",
    ...
    "No financial events in this period.": "此时间范围内没有财务事件。",
    "Click to edit...": "点击编辑...",
    "Created by": "创建者",
    "Depth": "层级",
    "Parent": "父级",
    "Started": "开始时间",
    "Lead": "负责人",
    "No scheduler heartbeats match the current criteria.": "没有调度器心跳符合当前筛选条件。",
    "Icon": "图标",
    "Metric": "指标",
    "Scope": "范围",
    "Window": "周期",
    ...
    "Preview failed": "预览失败",
    "Import preview": "导入预览",
    "Import {count} file(s)": "导入 {count} 个文件",
    ...
    "confirmed": "已确认",
    "skip": "跳过",
    "configure adapter": "配置适配器",
    "selected": "已选",
    "with": "包含",
    "{count} agent(s)": "{count} 个代理",
    "{company}: {count} agent(s) processed.": "{company}：已处理 {count} 个代理。",
    "No source configured.": "尚未配置来源。",
    "Failed to preview import.": "预览导入失败。",
    "Failed to read folder.": "读取文件夹失败。",
    "Package read failed": "读取包失败",
    "Import complete": "导入完成",
    "Import failed": "导入失败",
    "Importing...": "导入中...",
    "Failed to apply import.": "应用导入失败。",
    "file": "文件",
    "Export failed": "导出失败",
    "Failed to load export data.": "加载导出数据失败。",
    "Export downloaded": "导出已下载",
    "{count} file(s) exported as {name}.zip": "{count} 个文件已导出为 {name}.zip",
    "Failed to build export package.": "构建导出包失败。",
    "Loading export data...": "正在加载导出数据...",
    "{name} export": "{name} 导出",
    "Building export...": "正在构建导出包...",
    "Export {count} file(s)": "导出 {count} 个文件",
    "Package files": "包文件",
    "Search files...": "搜索文件...",
    "Show more issues ({visible} of {total})": "显示更多任务（{visible} / {total}）",
    "Select a file to preview its contents.": "选择一个文件以预览其内容。",
    ...
    "Cancelling…": "正在取消…",
    "Manage skills in the adapter directly.": "请直接在适配器中管理技能。",
    "Instructions bundles are only available for local adapters.":
      "说明包仅适用于本地适配器。",
    "Requested approval": "已发起审批请求",
    "Resuming…": "正在恢复…",
    "Revoked Keys": "已撤销的密钥",
    "Routines": "例行任务",
    "Beta": "测试版",
    ...
    "Recurring work definitions that materialize into auditable execution issues.":
      "可周期性触发、并落地为可审计执行任务的工作定义。",
    "Routine created": "例行任务已创建",
    "Routine run failed": "例行任务运行失败",
    "Select a company to view routines.": "选择一家公司以查看例行任务。",
    "No routines yet. Use Create routine to define the first recurring workflow.":
      "还没有例行任务。使用“创建例行任务”来定义第一个周期性工作流。",
    "No triggers configured yet.": "尚未配置触发器。",
    "Add trigger": "添加触发器",
    "Rotate secret": "轮换密钥",
    "Webhook secret rotated": "Webhook 密钥已轮换",
    "Webhook trigger created": "Webhook 触发器已创建",
    "Save routine": "保存例行任务",
    "Run now": "立即运行",
    "Archive": "归档",
    "Disable {title}": "停用 {title}",
    ...
    "Failed to save routine": "保存例行任务失败",
    "Failed to update routine": "更新例行任务失败",
    "Failed to add trigger": "添加触发器失败",
    "Failed to delete trigger": "删除触发器失败",
    "Failed to rotate webhook secret": "轮换 Webhook 密钥失败",
    "Failed to update trigger": "更新触发器失败",
    ...
    "Select a file to inspect.": "选择一个文件以查看。",
    "No skills match this filter.": "没有技能匹配当前筛选条件。",
    "skills.sh managed": "skills.sh 托管",
    ...
    "Read only": "只读",
    "Used by": "使用者",
    "No agents attached": "没有绑定代理",
    "Code": "代码",
    "Project skill scan complete": "项目技能扫描完成",
    "Project skill scan failed": "项目技能扫描失败",
    "Scan warnings": "扫描警告",
    "Skill conflicts found": "发现技能冲突",
    "Skill import failed": "技能导入失败",
    "Skill creation failed": "技能创建失败",
    "Skill created": "技能已创建",
    "Skill saved": "技能已保存",
    "Skill updated": "技能已更新",
    "Skills imported": "技能已导入",
    "Import warnings": "导入警告",
    "Select a company to manage skills.": "选择一家公司以管理技能。",
    "Add a skill source": "添加技能来源",
    "Paste a local path, GitHub URL, or `skills.sh` command into the field first.":
      "请先在输入框里粘贴本地路径、GitHub URL 或 `skills.sh` 命令。",
    "Browse skills.sh": "浏览 skills.sh",
    "Find install commands and paste one here.": "查找安装命令并粘贴到这里。",
    "Search GitHub": "搜索 GitHub",
    "Look for repositories with `SKILL.md`, then paste the repo URL here.":
      "寻找包含 `SKILL.md` 的仓库，然后把仓库 URL 粘贴到这里。",
    "{count} found": "找到 {count} 个",
    "{count} imported": "已导入 {count} 个",
    "{count} updated": "已更新 {count} 个",
    ...
    "Count": "数量",
    "Idle": "空闲",
    "imported company skills": "导入了公司技能",
    "scanned project skills": "扫描了项目技能",
    ...
    "Hide the username segment in home-directory paths and similar operator-visible log output. Standalone username mentions outside of paths are not yet masked in the live transcript view. This is off by default.":
      "隐藏主目录路径中的用户名片段，以及类似的面向操作员展示的日志输出。路径之外的独立用户名提及目前还不会在实时转录视图中脱敏。该选项默认关闭。",
    "Restart Required": "需要重启",
    "Auto-Restart On": "已开启自动重启",
    "Changed: {paths}": "已变更：{paths}",
    "Pending migrations: {migrations}": "待运行迁移：{migrations}",
    "Waiting for {count} live run(s) to finish": "正在等待 {count} 个活动运行结束",
    ...
    "Restart `pnpm dev:once` after the active work is safe to interrupt":
      "等当前工作安全可中断后，再重启 `pnpm dev:once`",
    "backend files changed and migrations are pending": "后端文件已变更，且仍有待运行迁移",
    "pending migrations need a fresh boot": "待运行迁移需要一次全新启动",
    "backend files changed since this server booted": "自本次服务启动以来，后端文件已发生变更",
    "just now": "刚刚",
    ...
    "clearing session...": "正在清除会话...",
    "Failed to clear sessions": "清除会话失败",
    "changed the status from {from} to {to}": "将状态从 {from} 改为 {to}",
    "changed the status to {status}": "将状态改为 {status}",
    "changed the priority from {from} to {to}": "将优先级从 {from} 改为 {to}",
    "changed the priority to {priority}": "将优先级改为 {priority}",
    "created a document": "创建了文档",
    "updated a document": "更新了文档",
    "deleted a document": "删除了文档",
    "breadcrumb": "面包屑导航",
  },
};
