 ...
 *
 * This is placed on `globalThis.__runeachPluginBridge__` and consumed by
...
declare global {
  ...
  var __runeachPluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__runeachPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__runeachPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
