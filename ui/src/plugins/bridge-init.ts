 ...
 *
 * This is placed on `globalThis.__chopsticksPluginBridge__` and consumed by
...
declare global {
  ...
  var __chopsticksPluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__chopsticksPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__chopsticksPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
