 ...
 *
 * This is placed on `globalThis.__abacusPluginBridge__` and consumed by
...
declare global {
  ...
  var __abacusPluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__abacusPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__abacusPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
