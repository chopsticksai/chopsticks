...
Chopsticks's UI is a professional-grade control plane, not a toy dashboard. It should feel like the kind of tool you live in all day — fast, keyboard-driven, information-dense without being cluttered, dark-themed by default. Every pixel should earn its place.
...
```
┌─────────────────────────────────────────────────────────────────────┐
│ Projects › Chopsticks › Issues › CLIP-42  [⭐] [···]     [🔔] [⬜] │
└─────────────────────────────────────────────────────────────────────┘
```
...
**Footer:**
- Attachment button (brain-circuit icon).
...
├─────────────────────────────────────────────────────────┤
│ [icon] Chopsticks Auth     Backlog     CTO     Feb 20   │
