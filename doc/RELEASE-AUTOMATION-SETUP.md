...
This document covers the GitHub and npm setup required for the current Abacus release model:
...
Do this for every public package that Abacus publishes.
...
3. add a trusted publisher for the GitHub repository `abacus-lab/abacus`
...
2. revoke any personal automation token that used to publish Abacus
