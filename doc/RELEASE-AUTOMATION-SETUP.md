...
This document covers the GitHub and npm setup required for the current RunEach release model:
...
Do this for every public package that RunEach publishes.
...
3. add a trusted publisher for the GitHub repository `runeachai/runeach`
...
2. revoke any personal automation token that used to publish RunEach
