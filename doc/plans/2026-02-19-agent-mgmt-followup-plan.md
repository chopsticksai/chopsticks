...
- `skills/chopsticks/SKILL.md` and `skills/chopsticks/references/api-reference.md` do not currently require markdown formatting quality for status comments (links, structure, readable updates).
...
## 6.1 `skills/chopsticks/SKILL.md`
...
## 6.2 `skills/chopsticks-create-agent/SKILL.md`
