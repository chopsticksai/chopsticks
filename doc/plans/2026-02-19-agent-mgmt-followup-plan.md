...
- `skills/runeach/SKILL.md` and `skills/runeach/references/api-reference.md` do not currently require markdown formatting quality for status comments (links, structure, readable updates).
...
## 6.2 `skills/runeach-create-agent/SKILL.md`
