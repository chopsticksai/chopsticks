...
- `skills/abacus/SKILL.md` and `skills/abacus/references/api-reference.md` do not currently require markdown formatting quality for status comments (links, structure, readable updates).
...
## 6.2 `skills/abacus-create-agent/SKILL.md`
