...
runeach already treats budgets as a core control-plane responsibility:
...
This plan defines the concrete budgeting model runeach should implement next.

## Product Goals

runeach should let operators:
...
For the next implementation pass, runeach should enforce these defaults:
...
runeach should separate subscription-included usage from billed spend:
...
runeach should have two threshold classes:
...
runeach must know that a project is budget-paused and enforce it.
...
runeach must also block execution before new work starts.
