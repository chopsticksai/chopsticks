...
import { createHostClientHandlers } from "@chopsticks/plugin-sdk";
...
export async function createApp(
  ...
  app.get("/api/auth/get-session", (req, res) => {
    ...
    res.json({
      session: {
        id: `chopsticks:${req.actor.source}:${req.actor.userId}`,
  ...
  if (opts.uiMode === "static") {
    ...
    if (uiDist) {
      ...
      console.warn("[chopsticks] UI dist not found; running in API-only mode");
    }
  }
