/**
 * PluginEventBus — typed in-process event bus for the RunEach plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@runeachai/shared";
import type { PluginEvent, EventFilter } from "@runeachai/plugin-sdk";
