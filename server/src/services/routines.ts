  ...
  return {
    ...
    createTrigger: async (
      ...
      if (input.kind === "webhook") {
        ...
        secretMaterial = {
          webhookUrl: `${process.env.RUNEACH_API_URL}/api/routine-triggers/public/${publicId}/fire`,
    ...
    rotateTriggerSecret: async (
      ...
      return {
        ...
        secretMaterial: {
          webhookUrl: `${process.env.RUNEACH_API_URL}/api/routine-triggers/public/${existing.publicId}/fire`,
