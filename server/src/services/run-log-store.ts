...
import { resolveChopsticksInstanceRoot } from "../home-paths.js";
...
export function getRunLogStore() {
  ...
  const basePath = process.env.RUN_LOG_BASE_PATH ?? path.resolve(resolveChopsticksInstanceRoot(), "data", "run-logs");
