...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@runeachai/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: RunEachPluginManifestV1, pluginDbId?: string): void;
