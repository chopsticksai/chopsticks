...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@chopsticks/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: ChopsticksPluginManifestV1, pluginDbId?: string): void;
