/**
 * Server-side SVG renderer for RunEach org charts.
...
// RunEach logo: scaled icon (~16px) + wordmark (13px), vertically centered
const RUNEACH_LOGO_SVG = `<g>
  ...
  <text x="22" y="11.5" font-family="system-ui, -apple-system, sans-serif" font-size="13" font-weight="600" fill="currentColor">RunEach</text>
</g>`;
