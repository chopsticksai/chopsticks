...
description: >
  Generate the stable RunEach release changelog at releases/vYYYY.MDD.P.md by
  reading commits, changesets, and merged PR context since the last stable tag.
---

# Release Changelog Skill

Generate the user-facing changelog for the **stable** RunEach release.

## Versioning Model

RunEach uses **calendar versioning (calver)**:
...
```
- **Feature name** - Description. ([#123](https://github.com/runeachai/runeach/pull/123), @contributor1, @contributor2)
```
