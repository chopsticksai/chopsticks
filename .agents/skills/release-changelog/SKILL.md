...
description: >
  Generate the stable Abacus release changelog at releases/vYYYY.MDD.P.md by
  reading commits, changesets, and merged PR context since the last stable tag.
---

# Release Changelog Skill

Generate the user-facing changelog for the **stable** Abacus release.

## Versioning Model

Abacus uses **calendar versioning (calver)**:
...
```
- **Feature name** - Description. ([#123](https://github.com/abacus-lab/abacus/pull/123), @contributor1, @contributor2)
```
