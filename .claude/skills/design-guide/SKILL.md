...
name: design-guide
description: >
  Swarmifyx UI design system guide for building consistent, reusable frontend
...
# Swarmifyx Design Guide

Swarmifyx's UI is a professional-grade control plane — dense, keyboard-driven, dark-themed by default. Every pixel earns its place.
...
2. **Custom composites** (`ui/src/components/`) — StatusBadge, EntityRow, MetricCard, etc. These capture Swarmifyx-specific design language.
