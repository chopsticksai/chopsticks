...
name: design-guide
description: >
  Abacus UI design system guide for building consistent, reusable frontend
...
Abacus's UI is a professional-grade control plane — dense, keyboard-driven, dark-themed by default. Every pixel earns its place.
...
2. **Custom composites** (`ui/src/components/`) — StatusBadge, EntityRow, MetricCard, etc. These capture Abacus-specific design language.
