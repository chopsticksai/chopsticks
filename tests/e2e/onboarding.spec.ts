 ...
 * heartbeat fires. Set RUNEACH_E2E_SKIP_LLM=false to enable LLM-dependent
 * assertions (requires a valid ANTHROPIC_API_KEY).
 */

const SKIP_LLM = process.env.RUNEACH_E2E_SKIP_LLM !== "false";
...
test.describe("Onboarding wizard", () => {
  test("completes full wizard flow", async ({ page }) => {
    ...
    expect(task.description).not.toContain("github.com/runeachai/companies");
