...
> - abacus orchestrates ai-agents for zero-human companies
...
> - This pull request adds per-adapter configuration of compaction, either auto or abacus managed
> - That way we can get optimal performance from any adapter/provider in abacus
