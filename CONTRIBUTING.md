...
> - runeach orchestrates ai-agents for zero-human companies
...
> - This pull request adds per-adapter configuration of compaction, either auto or runeach managed
> - That way we can get optimal performance from any adapter/provider in runeach
