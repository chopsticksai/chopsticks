...
base_cwd="${SWARMIFYX_WORKSPACE_BASE_CWD:?SWARMIFYX_WORKSPACE_BASE_CWD is required}"
worktree_cwd="${SWARMIFYX_WORKSPACE_CWD:?SWARMIFYX_WORKSPACE_CWD is required}"
