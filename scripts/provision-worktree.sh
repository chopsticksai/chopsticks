...
base_cwd="${CHOPSTICKS_WORKSPACE_BASE_CWD:?CHOPSTICKS_WORKSPACE_BASE_CWD is required}"
worktree_cwd="${CHOPSTICKS_WORKSPACE_CWD:?CHOPSTICKS_WORKSPACE_CWD is required}"
