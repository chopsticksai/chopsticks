...
RunEach supports three deployment configurations, from zero-friction local to internet-facing production.
...
- **Just trying RunEach?** Use `local_trusted` (the default)
