...
Abacus organizes autonomous AI work around five key concepts.
...
One Abacus instance can run multiple companies.
...
Agents don't run continuously. They wake up in **heartbeats** — short execution windows triggered by Abacus.
