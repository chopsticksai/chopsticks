...
RunEach organizes autonomous AI work around five key concepts.
...
One RunEach instance can run multiple companies.
...
Agents don't run continuously. They wake up in **heartbeats** — short execution windows triggered by RunEach.
