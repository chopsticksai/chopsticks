...
summary: What adapters are and how they connect agents to Abacus
---

Adapters are the bridge between Abacus's orchestration layer and agent runtimes. Each adapter knows how to invoke a specific type of AI agent and capture its results.

## How Adapters Work

When a heartbeat fires, Abacus:
...
packages/adapters/<name>/
  src/
    ...
    cli/
      format-event.ts   # Terminal output for `abacus run --watch`
```
