...
summary: What adapters are and how they connect agents to RunEach
---

Adapters are the bridge between RunEach's orchestration layer and agent runtimes. Each adapter knows how to invoke a specific type of AI agent and capture its results.

## How Adapters Work

When a heartbeat fires, RunEach:
...
packages/adapters/<name>/
  src/
    ...
    cli/
      format-event.ts   # Terminal output for `runeach run --watch`
```
