---
title: 快速开始
summary: 在几分钟内启动 Chopsticks
---

在 5 分钟内把 Chopsticks 跑起来。
...
这个命令会引导你完成初始化、配置环境，并启动 Chopsticks。
...
不需要额外数据库。Chopsticks 默认使用内嵌 PostgreSQL 实例。
