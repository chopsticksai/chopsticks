...
// ---------------------------------------------------------------------------
// Manifest sub-types — nested declarations within ChopsticksPluginManifestV1
// ---------------------------------------------------------------------------
...
/**
 * Lower-bound semver requirement for the Chopsticks host.
 *
...
export interface ChopsticksPluginManifestV1 {
   ...
   */
  minimumChopsticksVersion?: PluginMinimumHostVersion;
