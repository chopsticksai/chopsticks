...
// ---------------------------------------------------------------------------
// Manifest sub-types — nested declarations within AbacusPluginManifestV1
// ---------------------------------------------------------------------------
...
/**
 * Lower-bound semver requirement for the Abacus host.
 *
...
export interface AbacusPluginManifestV1 {
   ...
   */
  minimumAbacusVersion?: PluginMinimumHostVersion;
