...
// ---------------------------------------------------------------------------
// Manifest sub-types — nested declarations within RunEachPluginManifestV1
// ---------------------------------------------------------------------------
...
/**
 * Lower-bound semver requirement for the RunEach host.
 *
...
export interface RunEachPluginManifestV1 {
   ...
   */
  minimumRunEachVersion?: PluginMinimumHostVersion;
