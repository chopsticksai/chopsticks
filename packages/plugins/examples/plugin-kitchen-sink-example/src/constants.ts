import type { PluginLauncherRegistration } from "@runeachai/plugin-sdk";

export const PLUGIN_ID = "runeach-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".runeach-kitchen-sink-demo.txt",
} as const;
