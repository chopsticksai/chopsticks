...
import type { RunEachPluginManifestV1 } from "@runeachai/shared";

import type { RunEachPlugin } from "./define-plugin.js";
import type {
 ...
 * import { startWorkerRpcHost } from "@runeachai/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  let manifest: RunEachPluginManifestV1 | null = null;
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@runeachai/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
