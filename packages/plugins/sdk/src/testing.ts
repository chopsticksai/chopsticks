...
function requireCapability(manifest: AbacusPluginManifestV1, allowed: Set<PluginCapability>, capability: PluginCapability) {
 ...
 * can validate plugin behavior without spinning up the Abacus server runtime.
 */
