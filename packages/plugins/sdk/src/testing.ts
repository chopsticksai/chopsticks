...
function requireCapability(manifest: RunEachPluginManifestV1, allowed: Set<PluginCapability>, capability: PluginCapability) {
 ...
 * can validate plugin behavior without spinning up the RunEach server runtime.
 */
