/**
 * `@abacus/plugin-sdk/ui` — Abacus plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@abacus/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@abacus/plugin-sdk/ui";
 *
