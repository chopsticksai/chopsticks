/**
 * `@chopsticks/plugin-sdk/ui` — Chopsticks plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@chopsticks/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@chopsticks/plugin-sdk/ui";
 *
