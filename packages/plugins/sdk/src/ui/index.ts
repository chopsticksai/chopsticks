/**
 * `@runeachai/plugin-sdk/ui` — RunEach plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@runeachai/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@runeachai/plugin-sdk/ui";
 *
