 ...
 *
 * These components are exported from `@chopsticks/plugin-sdk/ui` and are
 ...
 *
 * @see PLUGIN_SPEC.md §19.6 — Shared Components In `@chopsticks/plugin-sdk/ui`
 */
...
function createSdkUiComponent<TProps>(name: string): React.ComponentType<TProps> {
  return function ChopsticksSdkUiComponent(props: TProps) {
