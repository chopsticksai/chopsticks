...
import type { PluginCategory, PluginStatus, ChopsticksPluginManifestV1 } from "@chopsticks/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<ChopsticksPluginManifestV1>().notNull(),
