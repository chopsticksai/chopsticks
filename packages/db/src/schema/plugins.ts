...
import type { PluginCategory, PluginStatus, RunEachPluginManifestV1 } from "@runeachai/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<RunEachPluginManifestV1>().notNull(),
