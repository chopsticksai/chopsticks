...
This document describes how `@runeachai/adapter-openclaw-gateway` invokes OpenClaw over the Gateway protocol.
...
5. stream `event agent` frames into RunEach logs/transcript parsing
