...
const DATA_DIR_OPTION_HELP =
  `${PUBLIC_PRODUCT_NAME} data directory root (isolates state from ~/.runeach)`;
...
program.hook("preAction", (_thisCommand, actionCommand) => {
  ...
  loadRunEachEnvFile(options.config);
});
...
program
  ...
  .option("--filename-prefix <prefix>", "Backup filename prefix", "runeach")
