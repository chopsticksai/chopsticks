...
const DATA_DIR_OPTION_HELP =
  `${PUBLIC_PRODUCT_NAME} data directory root (isolates state from ~/.abacus)`;
...
program.hook("preAction", (_thisCommand, actionCommand) => {
  ...
  loadAbacusEnvFile(options.config);
});
...
program
  ...
  .option("--filename-prefix <prefix>", "Backup filename prefix", "abacus")
